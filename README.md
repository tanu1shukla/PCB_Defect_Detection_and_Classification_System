...
### Topic: PCB Defect Detection and Classification System

Project Objectives:
- Develop an automated defect detection and classification system for Printed Circuit Boards (PCBs) using image processing and deep learning techniques. 
