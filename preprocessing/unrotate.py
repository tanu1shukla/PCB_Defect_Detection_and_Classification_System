...
rot_dir = r"Dataset\PCB_DATASET\rotation\Missing_hole_rotation"
angle_file = r"Dataset\PCB_DATASET\rotation\Missing_hole_angles.txt"
out_dir = r"preprocessing\unrotated\Missing_hole"
